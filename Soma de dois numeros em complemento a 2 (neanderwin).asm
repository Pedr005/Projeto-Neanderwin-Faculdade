...
; Autor: Pedro Florêncio
; Data: 09.06.2025
;---------------------------------------------------

x        EQU  128            ;local da memória onde vai ser guardada a variável
y        EQU  129            ;local da memória onde vai ser guardada a variável
z        EQU  130            ;local da memória onde vai ser guardada a variável
         ORG  0
LOOP1:
